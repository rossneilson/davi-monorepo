...
export class BaseERC20Guild__getProposalResultValue0Struct extends ethereum.Tuple {
  get creator(): Address {
...
export class BaseERC20Guild__getProposalVotesOfVoterResult {
  value0: BigInt;
  value1: BigInt;
...
export class BaseERC20Guild__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
...
export class BaseERC20Guild__proposalsResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: string;
...
export class BaseERC20Guild__tokensLockedResult {
  value0: BigInt;
  value1: BigInt;
...
export class BaseERC20Guild extends ethereum.SmartContract {
  static bind(address: Address): BaseERC20Guild {
    return new BaseERC20Guild("BaseERC20Guild", address);
  }

  MAX_ACTIONS_PER_PROPOSAL(): i32 {
    let result = super.call(
      "MAX_ACTIONS_PER_PROPOSAL",
      "MAX_ACTIONS_PER_PROPOSAL():(uint8)",
      []
    );
  ...
  try_MAX_ACTIONS_PER_PROPOSAL(): ethereum.CallResult<i32> {
  ...
  createProposal(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(totalActions),
  ...
  getProposal(
    proposalId: Bytes
  ): BaseERC20Guild__getProposalResultValue0Struct {
    let result = super.call(
      "getProposal",
    ...
    return changetype<BaseERC20Guild__getProposalResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getProposal(
    proposalId: Bytes
  ): ethereum.CallResult<BaseERC20Guild__getProposalResultValue0Struct> {
    let result = super.tryCall(
      "getProposal",
      "getProposal(bytes32):((address,uint256,uint256,address[],bytes[],uint256[],string,string,uint8,uint256[]))",
      [ethereum.Value.fromFixedBytes(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<BaseERC20Guild__getProposalResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getProposalVotesOfVoter(
    proposalId: Bytes,
    voter: Address
  ): BaseERC20Guild__getProposalVotesOfVoterResult {
    let result = super.call(
      "getProposalVotesOfVoter",
    ...
    return new BaseERC20Guild__getProposalVotesOfVoterResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getProposalVotesOfVoter(
    proposalId: Bytes,
    voter: Address
  ): ethereum.CallResult<BaseERC20Guild__getProposalVotesOfVoterResult> {
    let result = super.tryCall(
      "getProposalVotesOfVoter",
      "getProposalVotesOfVoter(bytes32,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BaseERC20Guild__getProposalVotesOfVoterResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  proposalVotes(
    param0: Bytes,
    param1: Address
  ): BaseERC20Guild__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new BaseERC20Guild__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_proposalVotes(
    param0: Bytes,
    param1: Address
  ): ethereum.CallResult<BaseERC20Guild__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(bytes32,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BaseERC20Guild__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  proposals(param0: Bytes): BaseERC20Guild__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new BaseERC20Guild__proposalsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toString(),
  ...
  try_proposals(
    param0: Bytes
  ): ethereum.CallResult<BaseERC20Guild__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(bytes32):(address,uint256,uint256,string,string,uint8)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BaseERC20Guild__proposalsResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toString(),
  ...
  tokensLocked(param0: Address): BaseERC20Guild__tokensLockedResult {
    let result = super.call(
      "tokensLocked",
    ...
    return new BaseERC20Guild__tokensLockedResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_tokensLocked(
    param0: Address
  ): ethereum.CallResult<BaseERC20Guild__tokensLockedResult> {
    let result = super.tryCall(
      "tokensLocked",
      "tokensLocked(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BaseERC20Guild__tokensLockedResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  votingPowerForProposalCreation(): BigInt {
    let result = super.call(
      ...
      "votingPowerForProposalCreation():(uint256)",
      []
    );
  ...
  try_votingPowerForProposalCreation(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "votingPowerForProposalCreation",
      "votingPowerForProposalCreation():(uint256)",
      []
  ...
  votingPowerForProposalExecution(): BigInt {
    let result = super.call(
      ...
      "votingPowerForProposalExecution():(uint256)",
      []
    );
  ...
  try_votingPowerForProposalExecution(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "votingPowerForProposalExecution",
      "votingPowerForProposalExecution():(uint256)",
      []
...
export class SetConfigCall__Inputs {
  ...
  get _votingPowerForProposalExecution(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }

  get _votingPowerForProposalCreation(): BigInt {
    return this._call.inputValues[3].value.toBigInt();
  }
