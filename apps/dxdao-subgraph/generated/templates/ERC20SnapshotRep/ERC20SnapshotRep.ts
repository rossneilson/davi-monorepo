...
export class ERC20SnapshotRep extends ethereum.SmartContract {
  static bind(address: Address): ERC20SnapshotRep {
    return new ERC20SnapshotRep("ERC20SnapshotRep", address);
  }
  ...
  getTotalHolders(): BigInt {
    let result = super.call(
      "getTotalHolders",
      "getTotalHolders():(uint256)",
      []
    );
  ...
  try_getTotalHolders(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getTotalHolders",
      "getTotalHolders():(uint256)",
      []
  ...
  totalHolders(): BigInt {
    let result = super.call("totalHolders", "totalHolders():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalHolders(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("totalHolders", "totalHolders():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
