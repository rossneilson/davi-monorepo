...
export class SnapshotERC20Guild__getProposalResultValue0Struct extends ethereum.Tuple {
  get creator(): Address {
...
export class SnapshotERC20Guild__getProposalVotesOfVoterResult {
  value0: BigInt;
  value1: BigInt;
...
export class SnapshotERC20Guild__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
...
export class SnapshotERC20Guild__proposalsResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: string;
...
export class SnapshotERC20Guild__tokensLockedResult {
  value0: BigInt;
  value1: BigInt;
...
export class SnapshotERC20Guild extends ethereum.SmartContract {
  static bind(address: Address): SnapshotERC20Guild {
    return new SnapshotERC20Guild("SnapshotERC20Guild", address);
  }
  ...
  getProposal(
    proposalId: Bytes
  ): SnapshotERC20Guild__getProposalResultValue0Struct {
    let result = super.call(
      "getProposal",
    ...
    return changetype<SnapshotERC20Guild__getProposalResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getProposal(
    proposalId: Bytes
  ): ethereum.CallResult<SnapshotERC20Guild__getProposalResultValue0Struct> {
    let result = super.tryCall(
      "getProposal",
      "getProposal(bytes32):((address,uint256,uint256,address[],bytes[],uint256[],string,string,uint8,uint256[]))",
      [ethereum.Value.fromFixedBytes(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<SnapshotERC20Guild__getProposalResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getProposalVotesOfVoter(
    proposalId: Bytes,
    voter: Address
  ): SnapshotERC20Guild__getProposalVotesOfVoterResult {
    let result = super.call(
      "getProposalVotesOfVoter",
    ...
    return new SnapshotERC20Guild__getProposalVotesOfVoterResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getProposalVotesOfVoter(
    proposalId: Bytes,
    voter: Address
  ): ethereum.CallResult<SnapshotERC20Guild__getProposalVotesOfVoterResult> {
    let result = super.tryCall(
      "getProposalVotesOfVoter",
      "getProposalVotesOfVoter(bytes32,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SnapshotERC20Guild__getProposalVotesOfVoterResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getVotingPowerForProposalExecution1(snapshotId: BigInt): BigInt {
    let result = super.call(
      "getVotingPowerForProposalExecution",
      "getVotingPowerForProposalExecution(uint256):(uint256)",
  ...
  try_getVotingPowerForProposalExecution1(
    snapshotId: BigInt
  ...
  proposalVotes(
    param0: Bytes,
    param1: Address
  ): SnapshotERC20Guild__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new SnapshotERC20Guild__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_proposalVotes(
    param0: Bytes,
    param1: Address
  ): ethereum.CallResult<SnapshotERC20Guild__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(bytes32,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SnapshotERC20Guild__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  proposals(param0: Bytes): SnapshotERC20Guild__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new SnapshotERC20Guild__proposalsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toString(),
  ...
  try_proposals(
    param0: Bytes
  ): ethereum.CallResult<SnapshotERC20Guild__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(bytes32):(address,uint256,uint256,string,string,uint8)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SnapshotERC20Guild__proposalsResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toString(),
  ...
  tokensLocked(param0: Address): SnapshotERC20Guild__tokensLockedResult {
    let result = super.call(
      "tokensLocked",
    ...
    return new SnapshotERC20Guild__tokensLockedResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_tokensLocked(
    param0: Address
  ): ethereum.CallResult<SnapshotERC20Guild__tokensLockedResult> {
    let result = super.tryCall(
      "tokensLocked",
      "tokensLocked(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SnapshotERC20Guild__tokensLockedResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  totalLockedAt(snapshotId: BigInt): BigInt {
    let result = super.call(
      "totalLockedAt",
      "totalLockedAt(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(snapshotId)]
    );
  ...
  try_totalLockedAt(snapshotId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalLockedAt",
      "totalLockedAt(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(snapshotId)]
